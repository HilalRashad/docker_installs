...
1. Clone the repo ( `git clone https://github.com/HilalRashad/docker_installs.git` ), or copy / paste the code from the `install_docker_nproxyman.sh` file into a file on your server. 
